...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'aucune_donnee' => 'goullo',
	'avis_probleme_ecriture_fichier' => 'Fazi en ur skrivañ ar restr @fichier@',

	// B
	'bouton_restaurer_base' => 'Assevel an diaz',

	// C
	'confirmer_ecraser_base' => 'Ya, c’hoant em eus flastrañ ma diaz gant ar saveteerezh-mañ',
	'confirmer_ecraser_tables_selection' => 'Ya, c’hoant em eus flastrañ gant ar saveteerezh-mañ an taolioù dibabet ',
	'confirmer_supprimer_sauvegarde' => 'C’hoant hoc’h eus dilemel ar saveteerezh-mañ ?',

	// D
	'details_sauvegarde' => 'Munudoù an saveteerezh :',
...
',
	...
	'info_restauration_finie' => 'Echu eo !. Ar saveteerezg @archive@ a zo bet adsevet en ho lec’h. Gallout a rit',
	'info_restauration_sauvegarde' => 'Assevel ar restr savete @archive@',
	'info_sauvegarde' => 'Saveteerezh',
	...
	// N
	'nb_donnees' => '@nb@ enrolladennoù',

	// R
	'restauration_en_cours' => 'Adsevelezh war ober',

	// S
	'sauvegarde_en_cours' => 'Saveteerezh war ober',
	'sauvegardes_existantes' => 'Saveteerezhoù bev',
	'selectionnez_table_a_restaurer' => 'Dibabit an taolioù o adsevel',
  ...
  Diwallit gant an arc’hwel-mañ, n’haller ket mont war-gil ma vez diverket pe gwallgaset tra pe dra.</b>',
	...
	'tout_sauvegarder' => 'Saveteiñ an holl taolioù',

	// U
	'une_donnee' => '1 enrolladenn'
);
